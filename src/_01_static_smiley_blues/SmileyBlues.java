...
public class SmileyBlues {
	void start() {
		...
		// 8. DO THIS LAST: 
		// Set the Smiley class' color variable to Smiley.YELLOW (NOT a specific smiley object's!)
		// Using a specific object for a static variable works, but is not recommended.
